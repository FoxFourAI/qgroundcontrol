...
Rectangle {
    ...
    radius:     _margins
    visible:    (_camera.capturesVideo || _camera.capturesPhotos || _camera.hasTracking || _camera.hasVideoStream) && !_headingSetter.isActive
    ...
    property var    _headingSetter:             _activeVehicle.autopilotPlugin.headingSetter
