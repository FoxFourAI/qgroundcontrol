...
{
    qDebug() << "FoxFourVideoReciever created";
...
gboolean FoxFourGstVideoReceiver::_filterParserCaps(GstElement *bin, GstPad *pad, GstElement *element, GstQuery *query, gpointer data)
{
...
GstElement *FoxFourGstVideoReceiver::_makeSource(const QString &input)
{
    if (input.isEmpty()) {
...
GstElement *FoxFourGstVideoReceiver::_makeDecoder(GstCaps *caps, GstElement *videoSink)
{
...
void FoxFourGstVideoReceiver::_wrapWithGhostPad(GstElement *element, GstPad *pad, gpointer data)
{
    Q_UNUSED(data)
...
void
FoxFourGstVideoReceiver::_linkVideoPad(GstElement* element, GstPad* pad, gpointer data)
{
...
void FoxFourGstVideoReceiver::_linkMedatadaPad(GstElement* element, GstPad* pad, gpointer data) {
...
gboolean FoxFourGstVideoReceiver::_padProbe(GstElement *element, GstPad *pad, gpointer user_data)
{
    Q_UNUSED(element)
...
gboolean FoxFourGstVideoReceiver::_padHasMetadataCaps(GstPad* pad) {
...
GstFlowReturn FoxFourGstVideoReceiver::_onNewMedatada(GstElement *sink, gpointer user_data) {
    FoxFourGstVideoReceiver* pThis = static_cast<FoxFourGstVideoReceiver *>(user_data);
